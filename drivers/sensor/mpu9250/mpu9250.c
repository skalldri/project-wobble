...
int mpu6050_init(struct device *dev)
{
	...
	drv_data->i2c = device_get_binding(CONFIG_MPU6050_I2C_MASTER_DEV_NAME); // This is the name of the bus in ninja config menu - kconfig (SPI_1)
...
#ifdef CONFIG_MPU6050_TRIGGER //important
